    ...
    <div class="main-content flex-grow-1">
        <div class="container-fluid px-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="fw-bold text-success mb-0">SwiftMart <span class="text-dark">Admin</span></h1>
                    <p class="text-muted">Vegetable E-Commerce Management</p>
                </div>
                <!-- <div class="text-end">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 fw-bold">{{$totalVendors}}</h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 fw-bold">{{$totalDeliveredItems}}</h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 fw-bold">₱{{$totalRevenue}}</h2>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-header bg-white border-0 py-3">
                            <h5 class="fw-bold mb-0">
                                <i class="fas fa-clock-rotate-left text-success me-2"></i>
                                Recent Orders
                            </h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach ($order->items as $item)
                                                        <p>{{ $item->product->name }} </p> <!-- Product Name & Price -->
                                                        
                                                    @endforeach
                                                </td>
                                                <td>{{ $order->status }}</td> <!-- Order Status -->
                                                <td>₱{{ number_format($order->total, 2) }}</td> <!-- Total Order Amount -->
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
