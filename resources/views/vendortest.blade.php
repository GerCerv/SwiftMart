...
<head>
    ...
    <style>
        ...
        /* Loading Spinner for Pagination and Tabs */
        .pagination-loading,
        .tab-loading-spinner {
            display: none;
            text-align: center;
...
<div class="d-flex flex-column">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3" id="sidebar">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="#dashboard" class="nav-link tab-link active" data-tab="dashboard">
                    <i class="bi bi-speedometer2"></i> Dashboard
                </a>
            </li>
            <li>
                <a href="#products" class="nav-link tab-link" data-tab="products">
                    <i class="bi bi-basket"></i> My Products
                </a>
            </li>
            <li>
                <a href="#orders" class="nav-link tab-link" data-tab="orders">
                    <i class="bi bi-cart3"></i> Orders
                </a>
            </li>
            <li>
                <a href="#reports" class="nav-link tab-link" data-tab="reports">
                    <i class="bi bi-graph-up"></i> Sales Reports
                </a>
            </li>
            <li>
                <a href="#settings" class="nav-link tab-link" data-tab="settings">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('.tab-link').on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const newContent = $response.find(`#${tabId} .${tabId}-content`).html();

                // Update content
                $tabPane.find(`.${tabId}-content`).html(newContent);
    ...
    // Initialize tab-specific handlers
    ...
    function reinitializeBootstrapComponents(tabId) {
        ...
        // Reinitialize charts for reports tab
        if (tabId === 'reports') {
            try {
    ...
    try {
        initializeProductHandlers();
        reinitializeBootstrapComponents('dashboard');
    } catch (error) {
    ...
    $('.tab-link').on('click', function() {
        console.log('Tab switched to: ' + $(this).data('tab'));
    });
});
</script>
</body>
